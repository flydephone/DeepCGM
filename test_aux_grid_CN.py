...
if __name__ == "__main__":
    ...
    for model in model_list[:1]:
        ...
        for i,(title,unit) in enumerate(zip(obs_name,units)):
            ...
            RMSE = (RMSE / len(x)) ** 0.5
            axs[i].text(x=0.025 * uplim, y=0.78 * uplim, s='RMSE=' + str(RMSE)[:5],fontsize=fontsize,c="black")
            axs[i].text(x=0.025 * uplim, y=0.9 * uplim, s='R$^2$ = ' + str(R2)[:5],fontsize=fontsize,c="black")
