...
if __name__ == "__main__":
    ...
    colors = ["cornflowerblue","lightcoral","lightcoral","cornflowerblue","lightcoral","lightcoral"]
    ...
    for ax, col, j in zip(axs[0], col_titles, range(ncols)):
        ...
        box_height = 0.07  # Height of the gray box
        if j==0:
        ...
        fig.text(box_x0 + box_width / 2, box_y0 + box_height / 2, col, ha="center", va="center", fontsize=8, color="black", zorder=4)
    fig.patches.append(Rectangle((big_box_x0, box_y0+box_height), big_box_x1-big_box_x0, 0.02, transform=fig.transFigure, facecolor="lightgray", edgecolor="black", zorder=3))
    fig.patches.append(Rectangle((big_box_x2, box_y0+box_height), big_box_x3-big_box_x2, 0.02, transform=fig.transFigure, facecolor="lightgray", edgecolor="black", zorder=3))
    fig.text(big_box_x0 + (big_box_x1-big_box_x0) / 2, box_y0+box_height + 0.01, "Sparse training set", ha="center", va="center", fontsize=8, color="black", zorder=4)
    fig.text(big_box_x2 + (big_box_x3-big_box_x2) / 2, box_y0+box_height + 0.01, "Interpolated training set", ha="center", va="center", fontsize=8, color="black", zorder=4)
